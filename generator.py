        ...
        for root, dirs, files in os.walk(self.project_path):
            ...
            for file in files:
                ...
                if file.endswith('.py'):
                    ...
                    structure['javascript_files'].append(str(relative_path))
                elif file.endswith(('.html', '.htm')):
                    structure['html_files'].append(str(relative_path))
                elif file.endswith(('.css', '.scss', '.sass')):
                    structure['css_files'].append(str(relative_path))
...
def _generate_readme_content(
    ...
    if dependencies['python']:
        ...
        content += "```bash\n"
        if any(file.endswith('requirements.txt') for file in file_structure['config_files']):
